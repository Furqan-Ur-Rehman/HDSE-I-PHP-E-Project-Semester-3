    ...
    <div class="AddcategoryModal" id="AddcategoryModal" style="display:none;">
        ...
        <form action="Operations/Compitition_Crud.php" method="post">
            <div class="Addaccount form-group row">
                ...
                <input type="text" name="compname" required class="form-control logininput col-9 mb-2">

                <label class="col-3">Topic</label>
                <input type="text" name="topic" required class="form-control logininput col-9 mb-2">


                <label class="col-3">Start Date</label>
                <input type="date"  name="startdate" required class="form-control logininput col-9 mb-2">


                <label class="col-3">Passing Marks</label>
                <input type="text"  name="passingmarks" required class="form-control logininput col-9 mb-2">
 

                <label class="col-3">Total Marks</label>
                <input type="text"  name="totalmarks" required class="form-control logininput col-9 mb-2">
