...
<div class="Box">
            <div class="addbutton">
                <h1 onclick="openAddModal()">ADD Cash Details</h1>
            </div>
            <div class="categoryTable">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <?php
                    $querys = 'select * from cash_on_delivery
                    ...
                    echo '<tr>'; ?>  
                      ...
                      <td><a href="Operations/CashDetail_Crud.php?Delid=<?= $data['cid'] ?>" onclick="return confirm('Are you sure you want to delete?'); return false;">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
                      <path d="M11 1.5v1h3.5a.5.5 0 0 1 0 1h-.538l-.853 10.66A2 2 0 0 1 11.115 16h-6.23a2 2 0 0 1-1.994-1.84L2.038 3.5H1.5a.5.5 0 0 1 0-1H5v-1A1.5 1.5 0 0 1 6.5 0h3A1.5 1.5 0 0 1 11 1.5Zm-5 0v1h4v-1a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5ZM4.5 5.029l.5 8.5a.5.5 0 1 0 .998-.06l-.5-8.5a.5.5 0 1 0-.998.06Zm6.53-.528a.5.5 0 0 0-.528.47l-.5 8.5a.5.5 0 0 0 .998.058l.5-8.5a.5.5 0 0 0-.47-.528ZM8 4.5a.5.5 0 0 0-.5.5v8.5a.5.5 0 0 0 1 0V5a.5.5 0 0 0-.5-.5Z"/>
                      </svg></a>
                      <a href="EditCashDetail.php?Updid=<?= $data['cid'] ?>">
    ...
    <div class="AddcategoryModal" id="AddcategoryModal" style="display: none;">
        ...
        <form action="Operations/CashDetail_Crud.php" method = "post">
            ...
            <select class="form-control logininput" required id="customername" name = "customername">
              ...
              <input type="text" name="postaladdress" required class="form-control logininput">

              <label>Contact</label>
              <input type="number" name="contact" required class="form-control logininput">
              
            <button type="submit" name="addcashdetail" class="btn btn-primary form-control mt-2" style="background-color:#5271ff;">Add</button>
            </div>
        </form>
    </div>
...
<div class="Box">
            ...
            <div class="categoryTable">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    $querys = 'select * from cash_on_delivery
                    INNER JOIN customer on customer.custid = cash_on_delivery.custid
                    where cash_on_delivery.custid = "'.@$_SESSION['Cust_id'].'"
                    ';
                    $res = mysqli_query($con, $querys);
                    while ($data = mysqli_fetch_assoc($res)) {
                    echo '<tr>'; ?>  
    ...
    Cash Details already <b>Exists</b> !
</div>
    ...
    Cash Details has been <b>Updated</b> Sucessfully!
</div>
...
Cash Details has been <b>Deleted</b> Sucessfully!
</div>
...
Cash Details has been <b>Added</b> Sucessfully!
</div>
<?php
@
  $ID = $_GET['added'];
