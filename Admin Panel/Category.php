        ...
        <div class="categoryTable">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <td>
                        <a href="Operations/Category_Crud.php?Delid=<?= $data['Catid'] ?>" onclick="return confirm('Are you Sure you want to delete?'); return false;">
...
<div class="AddcategoryModal" id="AddcategoryModal" style="display: none;">
    ...
    <form action="Operations/Category_Crud.php" method = "post">
        <div class="form-group">
          ...
          <input type="text" name="CategoryName" required class="form-control logininput">
