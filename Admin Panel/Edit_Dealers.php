    ...
    <div class="AddcategoryModal" id="AddcategoryModal" style="display: ;">
        ...
        <form action="Operations/Dealer_Crud.php" method = "post">
            <div class="Addaccount form-group row">
              ...
              <input type="text"  required style="background-color:darkgrey !important; color: white;" value = "<?= $catdata['dealerid']?>" name="DealerId" class="form-control logininput col-9 mb-2">
              
              <label class="col-3">Dealer Name</label>
              <input type="text" required  value = "<?= $catdata['Dealer_name']?>" name="DealerName" class="form-control logininput col-9 mb-2">
              
              <label class="col-3">Shop Name</label>
              <input type="text" required  value = "<?= $catdata['shop_Name']?>" name="shopName" class="form-control logininput col-9 mb-2">
              
              <label class="col-3">Shop Location</label>
              <input type="text" required  value = "<?= $catdata['Dealers_Location']?>" name="DealerLocation" class="form-control logininput col-9 mb-2">
              
              <label class="col-3">City</label>
              <input type="text" required  value = "<?= $catdata['City']?>" name="City" class="form-control logininput col-9 mb-2">

              <label class="col-3">Contact</label>
              <input type="text" required  value = "<?= $catdata['contact']?>" name="Contact" class="form-control logininput col-9 mb-2">
