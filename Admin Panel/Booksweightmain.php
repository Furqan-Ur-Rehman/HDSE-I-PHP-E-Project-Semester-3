                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    echo '<tr>'; ?>  
                      ...
                      <td><a href="Operations/Bookweight_Crud.php?Delid=<?= $data['weightid'] ?>" onclick="return confirm('Are you sure you want to delete?'); return false;">
    ...
    <div class="AddcategoryModal" id="AddcategoryModal" style="display: none;">
        ...
        <form action="Operations/Bookweight_Crud.php" method = "post">
            <div class="form-group">
              <label>Weight</label>
              <input type="text" name="weight" required class="form-control logininput">
              ...
              <select class="form-control logininput" required id="BookName" name = "booktype">
