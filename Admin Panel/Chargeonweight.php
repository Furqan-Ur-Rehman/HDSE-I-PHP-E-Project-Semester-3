                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    echo '<tr>'; ?>  
                      ...
                      <td><a href="Operations/Chargesonweaight_Crud.php?Delid=<?= $data['kgid'] ?>" onclick="return confirm('Are you sure to want to delete?'); return false;">
    ...
    <div class="AddcategoryModal" id="AddcategoryModal" style="display: none;">
        ...
        <form action="Operations/Chargesonweaight_Crud.php" method = "post">
            <div class="form-group">
              <label>Charges</label>
              <input type="text" name="charges" required class="form-control logininput">

              <label>Type</label>
              <select class="form-control logininput" required id="BookName" name ="weight">
